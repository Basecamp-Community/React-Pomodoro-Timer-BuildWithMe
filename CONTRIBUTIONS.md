...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a 
   build.
2. Update the [README.md](https://github.com/Basecamp-Community/React-Pomodoro-Timer-BuildWithMe/blob/main/README.md) with details of changes to the interface, this includes new environment 
   variables, exposed ports, useful file locations and container parameters.
3. Increase the version numbers in any examples files and the [README.md](https://github.com/Basecamp-Community/React-Pomodoro-Timer-BuildWithMe/blob/main/README.md) to the new version that this
